            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="lg:text-center justify-center flex flex-col items-center">
                    ...
                    <p className="mt-20 max-w-2xl text-xl text-gray-500 lg:mx-auto text-center">
                        Registered email : kshivam1177@gmail.com
                    </p>
                </div>

                <div className="mt-10">
                    <dl className="flex flex-row flex-wrap content-between justify-around absolute bottom-0 w-full">
                        {features.map((feature) => (
                            <div key={feature.name} className="relative">
                                <div className='flex flex-col items-center'>
                                    ...
                                    <p className=" text-lg font-medium text-gray-900">{feature.total}</p>
                                </div>
                            </div>
                        ))}
                    </dl>
